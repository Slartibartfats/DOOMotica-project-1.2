...
\begin{document}
	...
	\newpage
	\begin{figure}[h]
		\includegraphics[scale=0.5]{SendMessage}
		\caption{Code van commando versturen}
		\label{SendMessage}
	\end{figure}
\newpage
\begin{figure}[h]
	\includegraphics[scale=0.5]{ErrorHeater}
	\caption{Code voor Heater error}
	\label{ErrorHeater}
\end{figure}
\newpage
\begin{figure}[h]
	\includegraphics[scale=0.5]{SendMessagePSD}
	\caption{Send Message PSD}
	\label{SendMessagePSD}
\end{figure}
\newpage
\begin{figure}[h]
	\includegraphics[scale=0.5]{RadioButtonList}
