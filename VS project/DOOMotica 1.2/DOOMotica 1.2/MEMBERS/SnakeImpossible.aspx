<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="SnakeImpossible.aspx.cs" Inherits="DOOMotica_1._2.MEMBERS.SnakeMedium" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntnt_Body" runat="server">
    <asp:Label ID="lbl_Titel" runat="server" Text="" Font-Bold="True" Font-Size="X-Large"></asp:Label><br />
    <asp:Label ID="lbl_Bron" runat="server" Text="bron: "></asp:Label><asp:Label ID="lbl_BronUrl" runat="server" Text=""></asp:Label><br />
    <canvas width="850" height="600" id="canvas" style="border:1px solid #333;" onclick="snake.game.begin();">
</canvas>
    <asp:Label ID="lbl_bottom" runat="server" Text="Omschrijving: "></asp:Label>
